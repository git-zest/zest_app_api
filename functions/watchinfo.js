...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
module.exports.selectioncheck=function(modelname,modelnumber,callback){
  mongoose.connect('mongodb+srv://zestapp:ammu@cluster0-etvhe.mongodb.net/',{dbName: 'zest_app_mongodb'},function(err){
    ...
    var mobileregisterdata={"mobilemodelnumber":modelname,"mobilemodelname":modelnumber};
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
module.exports.selectionadd=function(modelname,modelnumber,event1,event2,callback){
  mongoose.connect('mongodb+srv://zestapp:ammu@cluster0-etvhe.mongodb.net/',{dbName: 'zest_app_mongodb'},function(err){
    if(err){
      console.log(err);
      db.close();
  ...
  var documets_mbl=new updateselectionobj({"mobilemodelnumber":modelname,"mobilemodelname":modelnumber,"event1":event1,"event2":event2,"event3":"","event4":""});
